...
def main():
    ...
    motors = np.array([Motor(0,0.7366,0.3048,0.8509), Motor(1,0.7366,-0.3048,0.8636), Motor(2, -0.7747, -.3048, 0.8255), Motor(3,-0.7747, 0.3048,0.8382)]);
    #motors = np.array([Motor(0,0.7366,0.3048,0.2302), Motor(1,0.7366,-0.3048,0.5370), Motor(2, -0.7747, -.3048, 1.3596), Motor(3,-0.7747, 0.3048,1.2667)]);
